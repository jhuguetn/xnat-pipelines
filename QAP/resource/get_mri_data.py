...
def get_scans_list(connection,project,subjectID,experimentID,required_type):
    ...
    for scanID in scans :
        ...
        if 'struct' in required_type.lower() and is_struct_scan(philips_scan_type_info,scans[scanID]['type'],scanID):
            process_scan_list.append(scanID)
            
        elif 'func' in required_type.lower() and is_func_scan(philips_scan_type_info,scans[scanID]['type'],scanID):
            process_scan_list.append(scanID)
