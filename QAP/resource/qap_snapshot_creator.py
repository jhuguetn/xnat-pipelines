...
def find_pdf_files(qap_output_directory):                            
    ''' Function that traverses all QAP output directory tree and locates target PDF files to be processed '''
    ''' Returns a list of matched files '''
    
    found_files = []
    target_file_types = [ 'fd.pdf', 'mosaic.pdf' ]
    
    for root, dirs, files in os.walk(qap_output_directory):
